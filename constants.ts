...
export const LOCATION_CHECK_INTERVAL_MS = 15000; 
export const DISCOVERY_PULSE_INTERVAL_MS = 15000; // Heartbeat for room list - now 15s
export const MESSAGE_THROTTLE_MS = 1000; 
